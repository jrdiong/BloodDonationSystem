...
<body>
    <?php include "navbar/navbar_organizer.php"; ?>
...
<div class="main-container">
  ...
  <h3>Edit Organizer Profile</h3>

  <div class="profile-field">
    <span class="field-label">Full Name</span>
    <span class="field-value">John Tan</span>
    <span class="edit-icon"><i class='bx bx-pencil'></i></span>
  </div>

  <div class="profile-field">
    <span class="field-label">Email</span>
    <span class="field-value">organizer@example.com</span>
    <span class="edit-icon"><i class='bx bx-pencil'></i></span>
  </div>

  <div class="profile-field">
    <span class="field-label">Phone</span>
    <span class="field-value">012-3456789</span>
    <span class="edit-icon"><i class='bx bx-pencil'></i></span>
  </div>

  <div class="profile-field">
    <span class="field-label">Organization Name</span>
    <span class="field-value">Red Cross Malaysia</span>
    <span class="edit-icon"><i class='bx bx-pencil'></i></span>
  </div>
</div>
