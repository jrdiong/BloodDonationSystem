...
<body>
    <?php include "navbar/navbar_hospital.php"; ?>
...
<div class="main-container">
  ...
  <div class="edit-section">
    ...
    <div class="profile-field">
      ...
      <span class="field-value" id="editNameValue">ABC Medical Center</span>
      <span class="edit-icon" data-field="name">
    ...
    <div class="profile-field">
      ...
      <span class="field-value" id="editEmailValue">hospital@example.com</span>
    ...
    <div class="profile-field">
      ...
      <span class="field-value" id="editPhoneValue">03-12345678</span>
      <span class="edit-icon" data-field="phone">
        <i class='bx bx-pencil'></i>
      </span>
    </div>
    ...
    <div class="profile-field">
      ...
      <span class="field-value" id="editLocationValue">
        Kuala Lumpur, Malaysia
      </span>
      <span class="edit-icon" data-field="location">
        <i class='bx bx-pencil'></i>
      </span>
    </div>
  </div>
...
function loadProfile() {
  ...
  document.getElementById("editLocationValue").textContent =
